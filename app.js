...
function dash(){
  ...
  const recent=`<div style="display:flex;flex-direction:column;gap:12px;"><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:var(--primary)">✓</span> <span>UFDR Uploaded</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:var(--primary)">✓</span> <span>Artifacts Extracted</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:var(--primary)">✓</span> <span>Entities Identified</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:var(--primary)">✓</span> <span>WECA Correlation Completed</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:var(--primary)">✓</span> <span>Risk Assessment Completed</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:var(--primary)">✓</span> <span>Graph Generated</span></div></div>`;
  const pipeline=`<div style="display:flex;flex-direction:column;gap:12px;"><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:#4ade80">✓</span> <span>Parser</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:#4ade80">✓</span> <span>Investigation Builder</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:#4ade80">✓</span> <span>Normalization</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:#4ade80">✓</span> <span>Evidence Index</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:#4ade80">✓</span> <span>WECA Engine</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:#4ade80">✓</span> <span>Risk Assessment</span></div><div style="display:flex;gap:12px;color:var(--text-secondary)"><span style="color:#4ade80">✓</span> <span>Knowledge Graph</span></div></div>`;

  return `<section class="hero-card"><div class="pill">Case Summary</div><h2 class="page-title" style="margin-top:.8rem;">Case: ${esc(i.name)}</h2><div style="display:flex;gap:2rem;margin-top:1.5rem;flex-wrap:wrap;"><div><span style="color:var(--text-secondary)">Status:</span> <span style="color:#4ade80;font-weight:500;">✅ Completed</span></div><div><span style="color:var(--text-secondary)">Device:</span> <span style="color:var(--text)">Samsung Galaxy S22</span></div><div><span style="color:var(--text-secondary)">Evidence Source:</span> <span style="color:var(--text)">UFDR</span></div><div><span style="color:var(--text-secondary)">Uploaded:</span> <span style="color:var(--text)">${fmt(i.uploadTime)||'19 Jul 2026 7:00 PM'}</span></div></div><div style="margin-top:2rem;display:flex;gap:1rem;"><a href="#/correlation" class="btn btn-primary">View Correlation Graph</a><a href="#/entities" class="btn" style="background:var(--border)">View Entities</a></div></section><section class="content-section">${kpi}</section><div class="split-grid"><section class="content-section"><h3 class="section-title">Artifact Distribution</h3><div style="margin-top:1.5rem">${bars}</div></section><section class="content-section"><h3 class="section-title">Priority Distribution</h3><div style="margin-top:1.5rem">${doughnut}${priLegend}</div></section></div><div class="split-grid"><section class="content-section"><h3 class="section-title">Top Correlations</h3><div style="margin-top:1.5rem">${topCorrHtml}</div></section><section class="content-section"><h3 class="section-title">Investigation Insights</h3><div style="margin-top:1.5rem">${insightsHtml}</div></section></div><div class="split-grid"><section class="content-section"><h3 class="section-title">Recent Activity</h3><div style="margin-top:1.5rem">${recent}</div></section><section class="content-section"><h3 class="section-title">Pipeline Status</h3><div style="margin-top:1.5rem">${pipeline}</div></section></div>`;
}
